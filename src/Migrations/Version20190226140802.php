 ...
 */
final class Version20190226140802 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE expositions_oeuvres DROP FOREIGN KEY FK_ED4C39533AF42CAB');
        $this->addSql('ALTER TABLE expositions_oeuvres DROP FOREIGN KEY FK_ED4C39534928CE22');
